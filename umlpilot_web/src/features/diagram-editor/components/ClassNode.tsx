...
export function ClassNode({ data }: { data: ClassNodeData }) {
  ...
  return (
    <div className="bg-white border-2 border-gray-800 rounded min-w-45 font-mono text-xs">
      ...
      <div className="px-2 py-1 border-b border-gray-300 min-h-5">
      ...
      <div className="px-2 py-1 min-h-5">
